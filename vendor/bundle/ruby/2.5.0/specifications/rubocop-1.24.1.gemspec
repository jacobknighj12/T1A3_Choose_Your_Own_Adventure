...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<regexp_parser>.freeze, ["< 3.0", ">= 1.8"])
      s.add_runtime_dependency(%q<rexml>.freeze, [">= 0"])
      s.add_runtime_dependency(%q<rubocop-ast>.freeze, ["< 2.0", ">= 1.15.1"])
      s.add_runtime_dependency(%q<ruby-progressbar>.freeze, ["~> 1.7"])
      s.add_runtime_dependency(%q<unicode-display_width>.freeze, ["< 3.0", ">= 1.4.0"])
      ...
      s.add_dependency(%q<regexp_parser>.freeze, ["< 3.0", ">= 1.8"])
      s.add_dependency(%q<rexml>.freeze, [">= 0"])
      s.add_dependency(%q<rubocop-ast>.freeze, ["< 2.0", ">= 1.15.1"])
      s.add_dependency(%q<ruby-progressbar>.freeze, ["~> 1.7"])
      s.add_dependency(%q<unicode-display_width>.freeze, ["< 3.0", ">= 1.4.0"])
